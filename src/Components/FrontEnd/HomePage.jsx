...
>
  <div className="max-w-7xl mx-auto px-4 md:px-10 lg:px-20 xl:px-28 2xl:px-36 py-20 mt-16 lg:py-15 flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
    <motion.div
  ...
  <div className="px-4 md:px-10 lg:px-10 xl:px-28 2xl:px-36 mt-2">
  ...
  <motion.div
    className="mt-4 px-4 lg:px-20 xl:px-28 2xl:px-36"
    initial={{ opacity: 0, y: 40 }}
    whileInView={{ opacity: 1, y: 0 }}
    transition={{ duration: 0.8 }}
    viewport={{ once: true }}
  ...
  <motion.div
    className="mt-2 px-4 lg:px-20 xl:px-28 2xl:px-36"
    initial="hidden"
    whileInView="visible"
    viewport={{ once: true }}
  >
  ...
  <motion.div
    className="mt-10 px-4 sm:px-6 lg:px-20 xl:px-28 2xl:px-36"
    initial="hidden"
    whileInView="visible"
    variants={fadeUp}
    viewport={{ once: true }}
  >
    <h2 className="text-2xl sm:text-3xl font-bold text-center mb-12">
      Our <span className="text-[#0057FF]">Projects</span>
    </h2>
  ...
  <motion.div
    className="py-16 px-4 sm:px-8 lg:px-20 xl:px-28 2xl:px-36"
    initial="hidden"
    whileInView="visible"
    variants={fadeUp}
    viewport={{ once: true }}
  >
    <h2 className="text-3xl font-bold text-center mb-4">
      Frequently <span className="text-[#0057FF]">Asked</span> Questions
    </h2>
    ...
    {faqData.map((item, index) => (
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <button
            className="text-white bg-[#0057FF] w-8 h-8 min-w-[2rem] min-h-[2rem] flex items-center justify-center rounded-full text-base sm:text-lg shadow-md"
