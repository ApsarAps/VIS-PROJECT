    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-7xl mx-auto">
          {[
            { img: RiyaImg, name: "Riya" },
            { img: JohanImg, name: "Johan" },
            { img: DanishImg, name: "Danish" },
            { img: RitikaImg, name: "Ritika" },
          ].map(({ img, name }, i) => (
            <motion.div
              key={name}
            ...
            >
              ...
              <div>
                ...
                <p className=" text-gray-700 text-lg leading-relaxed">
                  "Partnering with Vetri IT Systems was the best decision for
                  our business. Their expertise in software development and
                  cloud solutions helped us streamline our processes and boost
                  productivity significantly. Highly recommend!"
                </p>
