...
const HomePage = () => {
  return (
    ...
    >
      ...
      >
        <span className="text-[#0057FF]">Technology</span> is best when <br />
      ...
      >
        ...
        <p className="mt-4 text-gray-700 text-[15px] sm:text-[17px] max-w-3xl mx-auto">
          Our innovative process combines cutting-edge technology with creative problem-solving, 
          ensuring tailored solutions that drive efficiency and growth for our clients.
        </p>
      </motion.div>
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <img src={workProcessImage} alt="Work Process" className="w-full h-auto object-cover rounded-xl" />
      </motion.div>
      <motion.div
      ...
      >
        ...
        <p className="text-center text-gray-600 mb-10 max-w-2xl mx-auto">
          What Our Customers Are Saying. Hear from the people who trust us to deliver excellence every time.
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-7xl mx-auto">
          {[{ img: RiyaImg, name: "Riya" }, { img: JohanImg, name: "Johan" }, { img: DanishImg, name: "Danish" }, { img: RitikaImg, name: "Ritika" }].map(({ img, name }, i) => (
            <motion.div
              key={name}
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  "Partnering with Vetri IT Systems was the best decision for our business. Their expertise in software
                  development and cloud solutions helped us streamline our processes and boost productivity significantly. Highly recommend!"
                </p>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-7xl mx-auto">
          {[ProjectImg1, ProjectImg2, ProjectImg3, ProjectImg4].map((img, idx) => (
            <motion.img
              key={idx}
              src={img}
              alt={`Project ${idx + 1}`}
      ...
      >
        ...
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-10">
          We aim to provide clarity and transparency, ensuring you feel confident at every stage of your journey. If you have further questions, don’t hesitate to contact us directly!
        </p>
        ...
        <div className="space-y-4 max-w-3xl mx-auto">
          {[1, 2, 3, 4].map((_, index) => (
            <motion.div
              key={index}
              className="bg-blue-100 text-gray-800 px-4 py-3 rounded-lg flex items-center justify-between hover:shadow transition"
              whileHover={{ scale: 1.02 }}
            >
              <p className="text-sm sm:text-base">
                Lorem ipsum dolor sit amet consectetur. Diam arcu.
              </p>
              <button className="text-white bg-blue-600 rounded-full w-6 h-6 flex items-center justify-center">
                +
              </button>
            </motion.div>
          ))}
